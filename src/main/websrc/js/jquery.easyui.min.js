...
if(!data.length){
	...
	function childsel(sdata) {
		var myselect = true;
		if (sdata.children) {//如果有子节点 就循环子节点
...
if($.data(jq[0],"datagrid").data.data){
	$.data(jq[0],"datagrid").data.rows=$.data(jq[0],"datagrid").data.data.Datas || $.data(jq[0],"datagrid").data.data || $.data(jq[0],"datagrid").data || [];
	$.data(jq[0],"datagrid").data.total=$.data(jq[0],"datagrid").data.data.TotalRows || 0;
}else{
	$.data(jq[0],"datagrid").data.rows=[];
	$.data(jq[0],"datagrid").data.total=0;
}
...
_7ff.pageindex=_7ff.page;
_7ff.pagesize=_7ff.rows;
if(opts.contentType){
$.ajax({type:opts.method,url:opts.url,data:$.toJSON(_7ff),contentType:"application/json; charset=utf-8",dataType:"json",success:function(data){
_800(data);
},error:function(){
...
if(opts.contentType){
$.ajax({type:opts.method,url:opts.url,data:$.toJSON(_a29),contentType:"application/json; charset=utf-8",dataType:"json",success:function(data){
_a2a(data.data.Datas || data);
},error:function(){
